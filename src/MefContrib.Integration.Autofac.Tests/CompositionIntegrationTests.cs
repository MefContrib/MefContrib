namespace MefContrib.Integration.Autofac.Tests
{
    ...
    public class CompositionIntegrationTests
    {
        ...
        //[Test]
        //public void AutofacCannotResolveCompositionContainerWhenExplicitlyDisallowedTest()
        //{
        //    // Setup
        ...
        //    // Add composition support for autofac
        //    autofacContainer.AddExtension(new CompositionIntegration(false));
        //    autofacContainer.Configure<CompositionIntegration>().Catalogs.Add(assemblyCatalog);

        //    var internalCompositionContainer = autofacContainer.Configure<CompositionIntegration>().CompositionContainer;
        //    Assert.That(internalCompositionContainer, Is.Not.Null);
        //    Assert.That(autofacContainer.Configure<CompositionIntegration>().Register, Is.False);

        //    Assert.That(delegate
        //    {
        //        autofacContainer.Resolve<CompositionContainer>();
