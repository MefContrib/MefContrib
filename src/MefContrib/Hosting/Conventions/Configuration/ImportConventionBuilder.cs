namespace MefContrib.Hosting.Conventions.Configuration
{
    ...
    public class ImportConventionBuilder<TImportConvention> : 
        ConventionBuilder<TImportConvention> where TImportConvention : IImportConvention, new()
    {
        /// <summary>
        ...
        public ImportConventionBuilder<TImportConvention> AllowDefaultValue()
        {
        ...
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> ContractName(string contractName)
        {
        ...
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> ContractName(Func<MemberInfo, string> contractNameFunction)
        {
        ...
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> ContractType<TContractType>()
        {
        ...
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> ContractType(Func<MemberInfo, Type> contractTypeFunction)
        {
        ...
        /// </summary>
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> MakeNonShared()
        {
        ...
        /// </summary>
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> MakeShared()
        {
        ...
        public ImportConventionBuilder<TImportConvention> Members(Func<Type, MemberInfo[]> expression)
        {
            if (expression == null)
            {
        ...
        /// </summary>
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> Recomposable()
        {
        ...
        /// <returns>Returns a reference to the same <see cref="ImportConventionBuilder{TImportConvention}"/> instance as the method was called on.</returns>
        public ImportConventionBuilder<TImportConvention> RequireMetadata<TMetadataView>() where TMetadataView : class
        {
            var requiredMetadata =
