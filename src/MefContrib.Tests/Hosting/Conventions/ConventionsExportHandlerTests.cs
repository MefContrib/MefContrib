...
//        {
//            var exception =
//                Catch.Exception(() => new ConventionsExportHandler((IPartRegistry<IContractService>[])null));
...
//            var catalog =
//                new ConventionsExportHandler(locator.Object);
...
//        {
//            var exception =
//                Catch.Exception(() => new ConventionsExportHandler((IPartRegistryLocator)null));
...
//        {
//            var catalog =
//                new ConventionsExportHandler(new NonEmptyRegistry());
